...
function build_links(){
	if (config.links){
		if (config.links.spotify){
			create_link("Spotify", config.links.spotify, LANG.play, "../../_root_/images/spotify.svg")
		}
		if (config.links.youtube_music){
			create_link("YouTube Music", config.links.youtube_music, LANG.play, "../../_root_/images/youtube_music.svg", true)
		}
		if (config.links.youtube){
			create_link("YouTube", config.links.youtube, LANG.watch, "../../_root_/images/youtube.svg", true)
		}
		if (config.links.apple_music){
			create_link("Apple Music", config.links.apple_music, LANG.play, "../../_root_/images/apple_music.svg", true)
		}
		if (config.links.deezer){
			create_link("Deezer", config.links.deezer, LANG.play, "../../_root_/images/deezer.svg", true)
		}
		if (config.links.soundcloud){
			create_link("Soundcloud", config.links.soundcloud, LANG.play, "../../_root_/images/soundcloud.svg")
		}
		if (config.links.newgrounds){
			create_link("Newgrounds", config.links.newgrounds, LANG.watch, "../../_root_/images/newgrounds.svg", true)
		}
	}
	else{
